...
const sensitiveParamRegex =
  /(\b(?:key|api[_-]?key|apikey|token|access[_-]?token|secret|client[_-]?secret|password|dsn|authorization|app[_-]?id|appid|access[_-]?key)=)([^&\s"'<>]+)/gi;
const sensitiveAuthorizationRegex =
